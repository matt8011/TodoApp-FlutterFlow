...
class _LoginWidgetState extends State<LoginWidget>
  ...
  void initState() {
    ...
    _model.logEmailFieldTextController ??= TextEditingController();
    _model.logEmailFieldFocusNode ??= FocusNode();

    _model.logPassFieldTextController ??= TextEditingController();
    _model.logPassFieldFocusNode ??= FocusNode();
                ...
                child: Column(
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/do-doing-done-high-resolution-logo.png',
                        width: 167.7,
                        height: 67.7,
                        fit: BoxFit.contain,
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      SizedBox(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              .logEmailFieldTextController,
                                          focusNode:
                                              _model.logEmailFieldFocusNode,
                                          onChanged: (_) =>
                                              EasyDebounce.debounce(
                                            '_model.logEmailFieldTextController',
                                            const Duration(milliseconds: 2000),
                                            () => safeSetState(() {}),
                                          ),
                                          autofocus: false,
                                      ...
                                      SizedBox(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.logPassFieldTextController,
                                          focusNode:
                                              _model.logPassFieldFocusNode,
                                          autofocus: false,
                                          textInputAction: TextInputAction.done,
                                          obscureText:
                                              !_model.logPassFieldVisibility,
                                          decoration: InputDecoration(
                                            isDense: true,
                                            labelStyle:
                                                FlutterFlowTheme.of(context)
                                          ...
                                          cursorColor:
                                              FlutterFlowTheme.of(context)
                                                  .primaryText,
                                          validator: _model
                                              .logPassFieldTextControllerValidator
                                              .asValidator(context),
                                        ),
                                      ),
                                    ].divide(const SizedBox(height: 12.0)),
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              final user = await authManager.signInWithEmail(
                                context,
                                _model.logEmailFieldTextController.text,
                                _model.logPassFieldTextController.text,
                              );
                              if (user == null) {
                                return;
                              }
